...
const playSound = () => {
  player.play('register-chinging.wav', function(err){
    if (err) throw err
  })
...
const main = async () => {
  ...
  console.log('Program started .... ${name}')
  
  contract.on('Transfer', (from, to, amount, data) => {
    if(amount.toNumber() >= TRANSFER_THRESHOLD) {
      playSound()
	console.log('Fat Banker ${name} moved '+ amount.toNumber() + '   https://etherscan.io/tx/${data.transactionHash}');
    }
